...
function App(){return <>
  ...
  <main id="top">
    ...
    <section id="about" className="section-shell about-section"><div className="about-copy"><p className="eyebrow">About</p><h2>A structural biologist extending proven network methods into modern ML.</h2><p>I hold an MS in Genome Science and Technology and degrees in mathematics and experimental psychology. My work spans protein structure networks, clinical knowledge graphs, scientific visualization, graph learning, and GPU-based research infrastructure.</p><p>I am currently building validated public work at the intersection of computational structural biology and interpretable artificial intelligence.</p></div><aside className="contact-card"><span>Open to</span><h3>Research collaborations, computational biology roles, and scientific software partnerships.</h3><a href="mailto:davidfoutch42@gmail.com">davidfoutch42@gmail.com</a><div className="social-links"><a href="https://github.com/AgenticGraphAI">GitHub organization</a><a href="https://linkedin.com/in/david-foutch-117b121bb">LinkedIn</a></div></aside></section>
  </main>
